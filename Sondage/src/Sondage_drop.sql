...
Trimestre : 2024-1
Composant : Sondage_drop.sql (solution)
...
DROP DOMAIN Courriel;
DROP DOMAIN IdQuestionnaire;
DROP DOMAIN Matricule;
DROP DOMAIN NoChoix;
DROP DOMAIN Nom;
DROP DOMAIN NoQuestion;
DROP DOMAIN Titre;
DROP DOMAIN TypeQuestion;
